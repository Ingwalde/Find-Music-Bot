...
TRANSLATIONS = {
    ...
    "uk": {
        "welcome": (
            "🎧 Вітаю у Music Finder Bot!\n\n"
            "Я допоможу знайти пісні, артистів, альбоми та посилання Deezer.\n\n"
            "Натисни 🎵 Музика або просто напиши назву пісні."
        ),
        "help": (
            "Доступні команди:\n\n"
        ...
        "unsupported_language": "Ця мова не підтримується.",
        ...
        "something_wrong_searching": "Щось пішло не так під час пошуку. Спробуй ще раз.",
        "could_not_load_favorites": "Не вдалося завантажити улюблені.",
        "could_not_load_history": "Не вдалося завантажити історію.",
        "could_not_load_track": "Не вдалося завантажити інформацію про трек.",
        "could_not_repeat_search": "Не вдалося повторити цей пошук.",
        "history_item_not_found": "Елемент історії не знайдено.",
        "searching_again": "Шукаю ще раз...",
        "searching_lyrics": "Шукаю lyrics...",
        "lyrics_page_found": "Сторінку lyrics знайдено:",
        "admin_only": "Ця команда доступна тільки адміну бота.",
        "errors_empty": "✅ Збережених помилок немає.",
        "errors_header": "⚠️ Останні помилки:\n",
        "errors_cleared": "✅ Збережені помилки очищено.",
        "cancelled": "Скасовано.",
        "could_not_cancel": "Не вдалося скасувати.",
        "could_not_clear_history": "Не вдалося очистити історію.",
        "could_not_clear_favorites": "Не вдалося очистити улюблені.",
        "could_not_open_confirmation": "Не вдалося відкрити підтвердження.",
        "unknown_action": "Невідома дія.",
        "search_session_expired": "Сесія пошуку завершилась. Почни пошук ще раз.",
        "could_not_change_page": "Не вдалося змінити сторінку.",
        "could_not_return_results": "Не вдалося повернутися до результатів.",
        "btn_music": "🎵 Музика",
    ...
    "no": {
        ...
        "menu_buttons_disabled": "Menyknapper er bare tilgjengelige i hovedmenyen.\nTrykk ⬅️ Hovedmeny først.",
        ...
        "lyrics_not_found": "Lyrics-side ble ikke funnet.",
        "genius_error": "Kunne ikke hente lyrics nå. Prøv igjen senere.",
        "back_to_results_empty": "Søkeresultatene er ikke tilgjengelige lenger. Start et nytt søk.",
        "history_clear_confirm": "Er du sikker på at du vil tømme søkehistorikken?",
        "history_cleared": "🗑 Søkehistorikk tømt.",
        "favorites_clear_confirm": "Er du sikker på at du vil fjerne alle favoritter?",
        "favorites_cleared": "🗑 Favoritter tømt.",
        "choose_language": "Velg språk:",
        "language_changed": "Språket er endret til norsk.",
        "unsupported_language": "Språket støttes ikke.",
    ...
    "de": {
        ...
        "menu_buttons_disabled": "Menüknöpfe sind nur im Hauptmenü verfügbar.\nDrücke zuerst ⬅️ Hauptmenü.",
        ...
        "favorites_title": "⭐ Deine Favoriten: {count}\n\nKlicke auf einen Track:",
        "history_title": "🕘 Letzte Suchen: {count}\n\nKlicke auf eine Suche:",
    ...
    "fr": {
        ...
        "menu_buttons_disabled": "Les boutons du menu sont disponibles seulement dans le menu principal.\nAppuie d’abord sur ⬅️ Menu principal.",
        ...
        "favorites_title": "⭐ Tes favoris: {count}\n\nClique sur un titre:",
        "history_title": "🕘 Recherches récentes: {count}\n\nClique pour rechercher à nouveau:",
    ...
    "es": {
        ...
        "favorites_title": "⭐ Tus favoritos: {count}\n\nPulsa una canción:",
        "history_title": "🕘 Búsquedas recientes: {count}\n\nPulsa para buscar otra vez:",
    ...
    "it": {
        ...
        "favorites_title": "⭐ I tuoi preferiti: {count}\n\nPremi un brano:",
        "history_title": "🕘 Ricerche recenti: {count}\n\nPremi per cercare di nuovo:",
    ...
    "pl": {
        ...
        "favorites_title": "⭐ Twoje ulubione: {count}\n\nKliknij utwór:",
        "history_title": "🕘 Ostatnie wyszukiwania: {count}\n\nKliknij, aby wyszukać ponownie:",
