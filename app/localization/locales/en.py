TRANSLATIONS = {
    ...
    "btn_admin_cleanup_errors": "🧹 Cleanup errors",
    "btn_admin_cleanup_history": "🗑 Cleanup history",
    "btn_admin_health": "❤️ Health",
    "welcome": "🎧 Welcome to Music Finder Bot!\n\nI can help you find songs, artists, albums and Deezer/Spotify links.",
    "help": "Available commands:\n\n/start - Start bot\n/help - Show help\n/language - Change language\n/version - Show bot version\n/favorites - Show saved tracks\n/history - Show search history\n/similar - Find similar tracks\n/trending - Top tracks this week",
    "main_menu": "Main menu:",
    ...
    'admin_spotify_not_configured': 'not configured or disabled',
    'admin_spotify_temporary_cooldown': 'temporary cooldown',
    'admin_spotify_temporarily_disabled': 'temporarily disabled ({reason})',
    'admin_spotify_available': 'available',
    'admin_stats_title': '📊 Bot Statistics',
    'admin_stats_users': 'Users: {count}',
    'admin_stats_searches': 'Searches: {count}',
    'admin_stats_favorites': 'Favorites: {count}',
    'admin_stats_tracks': 'Tracks cached: {count}',
    'admin_stats_errors': 'Errors stored: {count}',
    'admin_stats_database_size': 'Database size: {size}',
    'admin_stats_spotify_status': 'Spotify status: {status}',
    'admin_maintenance_title': '🛠 Maintenance Report',
    'admin_maintenance_version': 'Version: v{version}',
    'admin_maintenance_schema': 'Schema version: v{version}',
    'admin_maintenance_database': 'Database: OK ({size})',
    'admin_maintenance_database_path': 'Database path: {path}',
    'admin_maintenance_rows': 'Rows: users={users}, searches={searches}, tracks={tracks}, favorites={favorites}, errors={errors}',
    'admin_maintenance_spotify': 'Spotify: {status}',
    'admin_cleanup_before': 'Before: {count}',
    'admin_cleanup_deleted': 'Deleted: {count}',
    'admin_cleanup_after': 'After: {count}',
    'admin_cleanup_errors_completed': 'Error cleanup completed',
    'admin_cleanup_history_completed': 'Search history cleanup completed',
    'admin_reload_completed': '✅ Admin configuration reloaded.',
    'similar_header': '🎯 Similar tracks for: {title} — {artist}',
    'similar_empty': 'No similar tracks found.',
    'similar_no_context': 'Open a track card first, then use /similar or tap 🎯 Similar.',
    'trending_header': '🔥 Trending tracks this week:',
